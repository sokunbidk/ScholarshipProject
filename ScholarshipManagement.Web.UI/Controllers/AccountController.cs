...
namespace ScholarshipManagement.Web.UI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(IUserService userService, IUserRepository userRepository, IApplicationService applicationService, IApplicationRepository applicationFormRepository, IStudentService studentService, IPaymentService paymentService)
        {
        ...
        public async Task<IActionResult> MakePayment(ApplicationDto model, int id)
        {
            ...
            return RedirectToAction("DisbursedList");
